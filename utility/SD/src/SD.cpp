...
// And an extra space for '\0' for path buffer
  ...
  bool walkPath(const char *filepath, SdFile2& parentDir,
                bool(*callback)(SdFile2& parentDir,
  ...
  */
  ...
  bool callback_pathExists(SdFile2& parentDir, const char *filePathComponent,
  ...
  bool callback_makeDirPath(SdFile2& parentDir, const char *filePathComponent,
                            bool isLastComponent, void *object) {
    /*
  ...
  */
  ...
  bool callback_remove(SdFile2& parentDir, const char *filePathComponent,
                       bool isLastComponent, void * /* object */) {
    if (isLastComponent) {
      return SdFile2::remove(parentDir, filePathComponent);
    }
    return true;
  }

  bool callback_rmdir(SdFile2& parentDir, const char *filePathComponent,
                      bool isLastComponent, void * /* object */) {
    if (isLastComponent) {
      SdFile2 f;
  ...
  SdFile2 SDClass::getParentDir(const char *filepath, int *index) {
  ...
  File2 SDClass::open(const char *filepath, uint8_t mode) {
    /*
    ...
    */
    ...
    SdFile2 parentdir = getParentDir(filepath, &pathidx);
    // no more subdirs!
  ...
  */
  ...
  File2 File2::openNextFile(uint8_t mode) {
    dir_t p;
  ...
  void File2::rewindDirectory(void) {
    if (isDirectory()) {
      _file->rewind();
    }
  }
