...
*/
class SdFile2 : public Print {
  public:
    /** Create an instance of SdFile. */
    SdFile2(void) : type_(FAT_FILE_TYPE_CLOSED) {}
    /**
    ...
    */
    ...
    uint8_t createContiguous(SdFile2* dirFile,
    ...
    */
    ...
    uint8_t makeDir(SdFile2* dir, const char* dirName);
    uint8_t open(SdFile2* dirFile, uint16_t index, uint8_t oflag);
    uint8_t open(SdFile2* dirFile, const char* fileName, uint8_t oflag);
    ...
    */
    ...
    static uint8_t remove(SdFile2* dirFile, const char* fileName);
    uint8_t remove(void);
    ...
    */
    ...
    /** \deprecated Use:
        uint8_t SdFile::createContiguous(SdFile* dirFile,
          const char* fileName, uint32_t size)
    */
    uint8_t createContiguous(SdFile2& dirFile,  // NOLINT
                             const char* fileName, uint32_t size) {
    ...
    */
    uint8_t makeDir(SdFile2& dir, const char* dirName) {  // NOLINT
      return makeDir(&dir, dirName);
    }
    /** \deprecated Use:
       uint8_t SdFile::open(SdFile* dirFile, const char* fileName, uint8_t oflag);
    */
    uint8_t open(SdFile2& dirFile, // NOLINT
                 const char* fileName, uint8_t oflag) {
      return open(&dirFile, fileName, oflag);
    }
    /** \deprecated  Do not use in new apps */
    uint8_t open(SdFile2& dirFile, const char* fileName) {  // NOLINT
      return open(dirFile, fileName, O_RDWR);
    }
    /** \deprecated Use:
       uint8_t SdFile::open(SdFile* dirFile, uint16_t index, uint8_t oflag);
    */
    uint8_t open(SdFile2& dirFile, uint16_t index, uint8_t oflag) {  // NOLINT
    ...
    */
    static uint8_t remove(SdFile2& dirFile, const char* fileName) {  // NOLINT
